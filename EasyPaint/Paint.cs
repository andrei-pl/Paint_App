...
namespace EasyPaint
{
    public partial class frmPaint : Form
    {
        ...
        ShapeKind shapeKind;
        ChosenColor color = ChosenColor.Black;
        Color chosenColor;
        ...
        public frmPaint()
        {
            ...
            this.pnlGraphic.Location = new System.Drawing.Point(108, 32);
        ...
        private void pnlGraphic_MouseMove(object sender, MouseEventArgs e)
        {
            if (paint)
            {
                ...
                if (color == ChosenColor.Black)
                {
                    chosenColor = Color.Black;
                }
                else if (color == ChosenColor.Yellow)
                {
                    chosenColor = Color.Yellow;
                }
                else if (color == ChosenColor.Red)
                {
                    chosenColor = Color.Red;
                }
                else if (color == ChosenColor.Blue)
                {
                    chosenColor = Color.Blue;
                }
                else if (color == ChosenColor.White)
                {
                    chosenColor = Color.White;
                }
                else if (color == ChosenColor.Green)
                {
                    chosenColor = Color.Green;
                }
                else if (color == ChosenColor.Orange)
                {
                    chosenColor = Color.Orange;
                }
                else if (color == ChosenColor.Purple)
                {
                    chosenColor = Color.Violet;
                }
                ...
                if (shapeKind == ShapeKind.Ellipse)
                {
                    ...
                    figure = new Shapes.EllipseInfo(tempStartPoint, absShapeWidth, absShapeHeight, chosenColor, shapeSize, fillShape);
                }
                else if (shapeKind == ShapeKind.Rectangle)
                {
                    ...
                    figure = new Shapes.RectangleInfo(tempStartPoint, absShapeWidth, absShapeHeight, chosenColor, shapeSize, fillShape);
                }
                else if (shapeKind == ShapeKind.Line)
                {
                    ...
                    figure = new Shapes.LineInfo(tempStartPoint, tempEndPoint, absShapeWidth, absShapeHeight, chosenColor, shapeSize);
                }
                else if (shapeKind == ShapeKind.Triangle)
                {
                    ...
                    figure = new Shapes.TriangleInfo(tempStartPoint, absShapeWidth, absShapeHeight, chosenColor, shapeSize, fillShape);//figure = new Shapes.TriangleInfo(startPoint, endPoint, shapeWidth, shapeHeight, chosenColor, shapeSize);
                }
            ...
            else if (selectionMode && isShapeWasSelected)
            {
                ...
                int qwe = tempShape.Width - (e.X - startPoint.X);
                int qwe2 = e.X - startPoint.X;
                int qwe3 = e.X;
                int qwe4 = startPoint.X;
